...
main.data <- data.frame(
    ...
    RDataPath = c("DEqMS/PXD004163.rds",
                  "DEqMS/DEqMS_1.17.0/miR_Proteins.rda",
                  "DEqMS/DEqMS_1.17.0/LFQ_benchmark.rda",
                  "DEqMS/DEqMS_1.17.0/UPS1-spike-in.rda"),
    BiocVersion=c("3.8","3.16","3.16","3.16"),
    SourceType="text",
    Genome = "hg38",
    SourceVersion = c("v1","v2","v2","v2"),
    Coordinate_1_based = TRUE,
    SourceUrl=c("ftp://ftp.pride.ebi.ac.uk/pride/data/archive/2016/06/PXD004163/Yan_miR_PSM_table.flatmzidtsv.txt",
                ...
                "ftp://massive.ucsd.edu/MSV000087597//quant/RD139_Software_Exports/Spectronaut_Mixed_Fasta_Export.csv"),
    Species=c("Homo Sapiens","Homo Sapiens","Homo Sapiens","yeast"),
